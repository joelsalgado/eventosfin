                        ...
                        [
                            ...
                            'value' => function($data){
                                ...
                                if($data->region_id == null){
                                    ...
                                    $reg = \common\models\RegionesSedesem::find()->where(['REGIONID' => $data->region_id])->one();
                                    $role = $reg->REGIONDESCRIPCION;
                                }

                                return $role;
                            },
                            'filter' => Html::activeDropDownList($searchModel, 'region_id',
                                \yii\helpers\ArrayHelper::map(\common\models\RegionesSedesem::getRegionesOk(), 'REGIONID', 'REGIONDESCRIPCION'),

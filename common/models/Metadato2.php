 ...
 * @property CatRegionesSedesem $cVEREGION
 */
class Metadato2 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['N_PERIODO', 'CVE_PROGRAMA', 'EDAD', 'EDAD2', 'EDAD_N', 'EDAD_N2', 'CODIGO_POSTAL', 'CVE_MUNICIPIO', 'CVE_ENTIDAD_FEDERATIVA', 'CVE_LOCALIDAD', 'CVE_REGION', 'CVE_CARGO1', 'CVE_CARGO2'], 'integer'],
            ...
            [['CVE_REGION'], 'exist', 'skipOnError' => true, 'targetClass' => CatRegionesSedesem::className(), 'targetAttribute' => ['CVE_REGION' => 'REGIONID']],
        ];
    }
    ...
    {
        return $this->hasOne(CatRegionesSedesem::className(), ['REGIONID' => 'CVE_REGION']);
    }
}
